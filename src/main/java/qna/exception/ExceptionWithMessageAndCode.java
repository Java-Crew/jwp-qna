...
public enum ExceptionWithMessageAndCode {
    ...
    NOT_FOUND_QUESTION(new NotFoundException("해당하는 질문을 찾을 수 없습니다.", 601)),

    // 답변 관련: 7xx
    UNAUTHORIZED_FOR_ANSWER(new UnauthorizedException("답변을 삭제할 권한이 없습니다.", 700)),
    CANNOT_DELETE_ANSWERS_WITH_ANOTHER_WRITER(new BadRequestException("다른 사람이 쓴 답변이 있어 전체 답변을 삭제할 수 없습니다.", 701)),
